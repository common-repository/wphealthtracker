...
if ( ! class_exists( 'WPHEALTHTRACKER_Edit_Users_Tab', false ) ) :
	/**
	 * WPHEALTHTRACKER_Edit_Users_Tab.
	 */
	class WPHEALTHTRACKER_Edit_Users_Tab {
		...
		public function __construct() {
			...
			require_once WPHEALTHTRACKER_CLASSES_UI_DISPLAY_DIR . 'class-wphealthtracker-editusers-form.php';

			// Instantiate the class.
			$this->template = new WPHEALTHTRACKER_UI_Display_Template();
			$this->form     = new WPHEALTHTRACKER_Edit_Users_Form();
...
// Instantiate the class.
$am = new WPHEALTHTRACKER_Edit_Users_Tab();
